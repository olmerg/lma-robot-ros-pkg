...
public:
  HelloRobot(const std::string& name):
    ...
    robot_x("robot_x"),robot_y("robot_y"),robot_theta("robot_theta"),robot_steer("robot_steer")  
    length(3),x0(0),y0(0),tetha0(0),gamma0(0),gammap(0),vel(0),time(0)
  {
    ...
    this->addPort(robot_theta).doc("Angle \\tetha of the robot");
    ...
    time=ts.secs+ts.msecs/1000.0+ts.usecs/1000000.0;
...
private:
 ...
 //TODO: hacer esto en una forma mas elegante	
    ...
    tetha0=tetha0+dt*vel*tan(gamma0)/length;
// deberia actualizar primero gamma y luego tetha????
    gamma0=gamma0+dt*gammap;
